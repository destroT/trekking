...
import { Ref, prop, getModelForClass, Severity, modelOptions } from "@typegoose/typegoose";
...
class RouteModel extends TimeStamps {
    ...
    @prop({ type: mongoose.Schema.Types.Mixed })
    upvotes: Map<Like, mongoose.Schema.Types.ObjectId>[]; // new Array<Like, mongoose.Types.ObjectId>()
